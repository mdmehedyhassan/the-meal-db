...
import SingleIngredientsDetails from './SingleIngredientsDetails';
            ...
            <div className="mt-5 mb-5 top-border-global-style">
                <div className="row">
                    <div className="col-md-4 mt-5">
                        <h2 style={{fontWeight: 700}} className="text-center">{ingredient}</h2>
                    ...
                    <div className="col-md-8">
                        <div className="row">
                            ...
                            {
                                meals?.map(meal => <SingleIngredientsDetails key={meal.idMeal} meal={meal}></SingleIngredientsDetails>)
                            }
                        </div>
                    </div>
                </div>
